...
- (instancetype)initWithFrame:(CGRect)frame With:(ShoppingCarBottomModel *)bottomModel{
    ...
    if(self)
    {
        ...
        _views.frame=CGRectMake(10, 100,100,100);
        [self addSubview:_views];
        
        _allselectBtn.frame = CGRectMake(10, -44, 20, 20);
        
        allselectLabel.frame = CGRectMake(10, -19, 60, 20);
        
        _resultPriceLl.frame = CGRectMake(70, -39, 80, 30);
        
        endButton.frame = CGRectMake(250, -49, self.frame.size.width-250, self.frame.size.height);
